...
<div style="width: 500px ;margin: 0 auto; margin-top: 50px">
    <form name="taxiOffice" action="" method="POST">
        ...
        <<div class="input-group input-group-sm mb-3">
            <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">Order Number</span>
            <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"
            <@spring.formInput "orderForm.orderNumber" "" "text"/>
        </div>
        <div class="input-group input-group-sm mb-3">
            <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">start Address</span>
            <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"
            <@spring.formInput "orderForm.startAddress" "" "text"/>
        </div>

        <div class="input-group input-group-sm mb-3">
            <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">end Address</span>
            <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"
            <@spring.formInput "orderForm.endAddress" "" "text"/>
        </div>

        <div class="input-group input-group-sm mb-3">
            <label class="input-group-text" style="width: 120px" for="inputGroupSelect01">isOutOfCity</label>
            <select class="form-select" id="inputGroupSelect01"
            <@spring.formSingleSelect "orderForm.isOutOfCity", state, ""/>
        </div>

        <div class="input-group input-group-sm mb-3">
            <label class="input-group-text" style="width: 120px" for="inputGroupSelect01">customer</label>
            <select class="form-select" id="inputGroupSelect01"
            <@spring.formSingleSelect "orderForm.customer", customers, ""/>
        </div>

        <div class="input-group input-group-sm mb-3">
            <label class="input-group-text" style="width: 120px" for="inputGroupSelect01">operator</label>
            <select class="form-select" id="inputGroupSelect01"
            <@spring.formSingleSelect "orderForm.operator", operators, "text"/>
        </div>

        <div class="input-group mb-3">
            <label class="input-group-text" style="width: 120px" for="inputGroupSelect01">car</label>
            <select class="form-select" id="inputGroupSelect01"
            <@spring.formSingleSelect "orderForm.car", cars, ""/>
        </div>
<#--        <div class="input-group mb-3">-->
<#--            <label class="input-group-text" style="width: 120px" for="inputGroupSelect01">driver</label>-->
<#--            <select class="form-select" id="inputGroupSelect01"-->
<#--            <@spring.formSingleSelect "orderForm.driver", drivers, ""/>-->
<#--        </div>-->
        <div class="input-group mb-3">
            <label class="input-group-text" style="width: 120px" for="inputGroupSelect01">completed</label>
            <select class="form-select" id="inputGroupSelect01"
            <@spring.formSingleSelect "orderForm.completed", state, ""/>
        </div>
