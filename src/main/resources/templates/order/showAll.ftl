...
<table class="table">
    ...
    <tr>
        <td><a href="/ui/order/get/${order.id}">${order.id}</a></td>
        <td>${order.orderNumber}</td>
        <td>${order.startAddress}</td>
        <td>${order.endAddress}</td>
        <td><#if isOut == true>Yes</#if><#if isOut != true>No</#if></td>
        <td><a href="/ui/customer/get/${order.customer.id}">${order.customer.name}</a></td>
        <td><a href="/ui/operator/get/${order.operator.id}">${order.operator.name}</a></td>
        <td><a href="/ui/car/get/${order.car.id}">${order.car.carNumber}</a></td>
        <td><a href="/ui/driver/get/${order.car.driver.id}">${order.car.driver.name}</a></td>
        <td><#if compl == true>Yes</#if><#if compl != true>No</#if></td>
        <td><a href="/ui/order/update/${order.id}"><button type="button" class="btn btn-outline-dark">Update</button></a></td>
        <td><a href="/ui/order/delete/${order.id}"><button type="button" class="btn btn-outline-dark">Delete</button></a></td>
        <td><a href="/ui/check/create/${order.id}"><button type="button" class="btn btn-outline-dark">Create check</button></a></td>
    </tr>
    </#list>
</table>
    <a href="/ui/order/create"><button type="button" class="btn btn-outline-dark">Create</button></a>
</div>
</body>
</html>