...
<table class="table">
    ...
    <#list driverSalaryForDay as salary>
    <tr>
        <td><a href="/ui/salary/forday/driver/get/${salary.id}">${salary.id}</a></td>
        <td>${salary.createTime}</td>
        <td>${salary.salary}</td>
        <td><a href="/ui/driver/get/${salary.driver.id}">${salary.driver.name}</a></td>
        <td><a href="/ui/salary/forday/driver/update/${salary.id}"><button type="button" class="btn btn-outline-dark">Update</button></a></td>
        <td><a href="/ui/salary/forday/driver/delete/${salary.id}"><button type="button" class="btn btn-outline-dark">Delete</button></a></td>
    </tr>
    </#list>
</table>
    <a href="/ui/salary/forday/driver/create"><button type="button" class="btn btn-outline-dark">Create</button></a>
</div>
</body>
</html>