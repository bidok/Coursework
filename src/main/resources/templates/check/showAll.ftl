...
<table class="table">
    ...
    <#list check as check>
    <tr>
        <td><a href="/ui/check/get/${check.id}">${check.id}</a></td>
        <td>${check.checkNumber}</td>
        <td><a href="/ui/order/get/${check.order.id}">${check.order.orderNumber}</a></td>
        <td>${check.distance}</td>
        <td>${check.price}</td>
        <td><a href="/ui/check/update/${check.id}"><button type="button" class="btn btn-outline-dark">Update</button></a></td>
        <td><a href="/ui/check/delete/${check.id}"><button type="button" class="btn btn-outline-dark">Delete</button></a></td>

    </tr>
    </#list>
</table>
    <a href="/ui/check/create"><button type="button" class="btn btn-outline-dark">Create</button></a>
</div>
</body>
</html>