    ...
    <div style="width: 400px; margin: 0 auto; margin-top: 50px">
        ...
        <ul class="list-group">
            ...
            <div class="input-group input-group-sm mb-3">
                ...
                <input type="text" readonly placeholder=${car.getId()}  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 150px">Car Number</span>
                <input type="text" readonly placeholder=${car.getCarNumber()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 150px">State</span>
                <input type="text" readonly placeholder=<#if a == true>True</#if><#if a != true>False</#if>
                                                         class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 150px">Location</span>
                <input type="text" readonly placeholder=${car.getLocation()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 150px">Insurance Number</span>
                <input type="text" readonly placeholder=${car.getInsuranceNumber()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>

            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 150px">Taxi Office</span>
                <input  type="text" readonly placeholder=${car.getTaxiOffice().getName()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>

            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 150px">Driver</span>
                <input type="text" readonly placeholder=${car.getDriver().getName()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 150px">Model</span>
                <input type="text" readonly placeholder=${car.getModell().getName()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
<#--            <div class="input-group input-group-sm mb-3">-->
...
<#--            </div>-->
            <div class="input-group input-group-sm mb-3">
                ...
                <input type="text" readonly placeholder=${car.getCreateTime()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 150px">Updated At</span>
                <input type="text" readonly placeholder=${car.getUpdateTime()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
        </ul>
        <a href="/ui/driver/get/all"><button type="button" class="btn btn-outline-dark">To the list</button></a>
        <a style="float: right" href="/ui/taxioffice/get/${car.getTaxiOffice().getId()}"><button type="button" class="btn btn-outline-dark" >Taxi Office</button></a>
        <a style="float: right" href="/ui/driver/get/${car.getDriver().getId()}"><button type="button" class="btn btn-outline-dark" >Driver</button></a>
        <a style="float: right" href="/ui/model/get/${car.getModell().getId()}"><button type="button" class="btn btn-outline-dark" >Model</button></a>
    </div>
</body>
</html>