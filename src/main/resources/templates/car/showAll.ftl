...
<table class="table">
    ...
    <#list cars as car>
    <tr>
        <td><a href="/ui/car/get/${car.id}">${car.id}</a></td>
        <td>${car.carNumber}</td>
        <td>${car.location}</td>
        <td>${car.insuranceNumber}</td>
        <td><a href="/ui/taxioffice/get/${car.taxiOffice.id}">${car.taxiOffice.name}</a></td>
        <td><a href="/ui/driver/get/${car.driver.id}">${car.driver.name}</a></td>
        <td><a href="/ui/model/get/${car.modell.id}">${car.modell.name}</a></td>
<#--        <td>${car.state.booleanValue()}</td>-->
        <td><a href="/ui/car/update/${car.id}"><button type="button" class="btn btn-outline-dark">Update</button></a></td>
        <td><a href="/ui/car/delete/${car.id}"><button type="button" class="btn btn-outline-dark">Delete</button></a></td>
    </tr>
    </#list>
</table>
    <a href="/ui/car/create"><button type="button" class="btn btn-outline-dark">Create</button></a>
</div>
</body>
</html>