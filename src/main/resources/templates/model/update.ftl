...
<div style="width: 500px ;margin: 0 auto; margin-top: 50px">
    <form name="taxiOffice" action="" method="POST">
        ...
        <div class="input-group input-group-sm mb-3">
            <label class="input-group-text" style="width: 120px" for="inputGroupSelect01">marka</label>
            <select class="form-select" id="inputGroupSelect01"
            <@spring.formSingleSelect "modelForm.marka", markas,""/>
        </div>
        <div class="input-group input-group-sm mb-3">
            <label class="input-group-text" style="width: 120px" for="inputGroupSelect01">car class</label>
            <select class="form-select" id="inputGroupSelect01"
            <@spring.formSingleSelect "modelForm.carClass", carClasses,""/>
        </div>
        <div class="input-group input-group-sm mb-3" style="color: grey">
            <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">Date</span>
