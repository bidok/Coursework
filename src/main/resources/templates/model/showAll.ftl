...
<table class="table">
    ...
    <#list modells as model>
    <tr>
        <td><a href="/ui/model/get/${model.id}">${model.id}</a></td>
        <td>${model.name}</td>
        <td>${model.getMarka()}</td>
        <td>${model.getCarClass()}</td>
        <td>${model.getDate()}</td>
        <td><a href="/ui/model/update/${model.id}"><button type="button" class="btn btn-outline-dark">Update</button></a></td>
        <td><a href="/ui/model/delete/${model.id}"><button type="button" class="btn btn-outline-dark">Delete</button></a></td>
    </tr>
    </#list>
</table>
    <a href="/ui/model/create"><button type="button" class="btn btn-outline-dark">Create</button></a>
</div>
</body>
</html>