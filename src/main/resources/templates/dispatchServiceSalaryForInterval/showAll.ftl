...
<table class="table">
    ...
    <#list dispatchServiceSalaryForInterval as salary>
    <tr>
        <td><a href="/ui/salary/forinterval/dispatchservice/get/${salary.id}">${salary.id}</a></td>
        <td>${salary.from}</td>
        <td>${salary.to}</td>
        <td>${salary.salary}</td>
        <td><a href="/ui/salary/forinterval/dispatchservice/update/${salary.id}"><button type="button" class="btn btn-outline-dark">Update</button></a></td>
        <td><a href="/ui/salary/forinterval/dispatchservice/delete/${salary.id}"><button type="button" class="btn btn-outline-dark">Delete</button></a></td>
    </tr>
    </#list>
</table>
    <a href="/ui/salary/forinterval/dispatchservice/create"><button type="button" class="btn btn-outline-dark">Create</button></a>
</div>
</body>
</html>