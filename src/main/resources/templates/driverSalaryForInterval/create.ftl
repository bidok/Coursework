    ...
    <div style="width: 500px;margin: 0 auto; margin-top: 50px">
        <form name="taxiOffice" action="" method="POST">
            <div class="input-group input-group-sm mb-3">
                ...
                <@spring.formInput "salaryForIntervalForm.salary" "" "text"/>
            </div>
            <div class="input-group input-group-sm mb-3">
                ...
                <@spring.formInput "salaryForIntervalForm.from" "" "text"/>
                ...
                <input type="date" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"
                <@spring.formInput "salaryForIntervalForm.to" "" "text"/>
            </div>

            <div class="input-group input-group-sm mb-3">
                <label class="input-group-text" style="width: 120px" for="inputGroupSelect01">Driver</label>
                <select class="form-select" id="inputGroupSelect01"
                <@spring.formSingleSelect "salaryForIntervalForm.entity", drivers, "text"/>
            </div>
