...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div style="width: 400px; margin: 0 auto; margin-top: 50px">
        <h1 style="margin-left: 35%">driver Salary For Interval</h1>
        <ul class="list-group">

            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">ID</span>
                <input type="text" readonly placeholder=${driverSalaryForInterval.getId()}  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">Driver Name</span>
                <input type="text" readonly placeholder=${driverSalaryForInterval.getDriver().getName()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">Salary</span>
                <input type="text" readonly placeholder=${driverSalaryForInterval.getSalary()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">From</span>
                <input type="text" readonly placeholder=${driverSalaryForInterval.getFrom()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">To</span>
                <input type="text" readonly placeholder=${driverSalaryForInterval.getTo()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">Created at</span>
                <input type="text" readonly placeholder=${driverSalaryForInterval.getCreateTime()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">updated at</span>
                <input type="text" readonly placeholder=${driverSalaryForInterval.getUpdateTime()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
        </ul>
        <a href="/ui/salary/forinterval/driver/get/all"><button type="button" class="btn btn-outline-dark">To the list</button></a>
        <a style="float: right" href="/ui/driver/get/${driverSalaryForInterval.getDriver().getId()}"><button type="button" class="btn btn-outline-dark" >To driver</button></a>
    </div>
</body>
</html>