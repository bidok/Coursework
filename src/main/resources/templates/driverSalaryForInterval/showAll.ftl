...
<table class="table">
    ...
    <#list driverSalaryForInterval as salary>
    <tr>
        <td><a href="/ui/salary/forinterval/driver/get/${salary.id}">${salary.id}</a></td>
        <td>${salary.from}</td>
        <td>${salary.to}</td>
        <td>${salary.salary}</td>
        <td><a href="/ui/driver/get/${salary.driver.id}">${salary.driver.name}</a></td>
        <td><a href="/ui/salary/forinterval/driver/update/${salary.id}"><button type="button" class="btn btn-outline-dark">Update</button></a></td>
        <td><a href="/ui/salary/forinterval/driver/delete/${salary.id}"><button type="button" class="btn btn-outline-dark">Delete</button></a></td>
    </tr>
    </#list>
</table>
    <a href="/ui/salary/forinterval/driver/create"><button type="button" class="btn btn-outline-dark">Create</button></a>
</div>
</body>
</html>