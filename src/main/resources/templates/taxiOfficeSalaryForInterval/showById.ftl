    ...
    <div style="width: 400px; margin: 0 auto; margin-top: 50px">
        ...
        <ul class="list-group">
            ...
            <div class="input-group input-group-sm mb-3">
                ...
                <input type="text" readonly placeholder=${taxiOfficeSalaryForInterval.getId()}  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">taxi Office</span>
                <input type="text" readonly placeholder=${taxiOfficeSalaryForInterval.getTaxiOffice().getName()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">Salary</span>
                <input type="text" readonly placeholder=${taxiOfficeSalaryForInterval.getSalary()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">From</span>
                <input type="text" readonly placeholder=${taxiOfficeSalaryForInterval.getFrom()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">To</span>
                <input type="text" readonly placeholder=${taxiOfficeSalaryForInterval.getTo()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">Created at</span>
                <input type="text" readonly placeholder=${taxiOfficeSalaryForInterval.getCreateTime()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">updated at</span>
                <input type="text" readonly placeholder=${taxiOfficeSalaryForInterval.getUpdateTime()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
        </ul>
        <a href="/ui/salary/forinterval/taxioffice/get/all"><button type="button" class="btn btn-outline-dark">To the list</button></a>
        <a style="float: right" href="/ui/taxioffice/get/${taxiOfficeSalaryForInterval.getTaxiOffice().getId()}"><button type="button" class="btn btn-outline-dark" >To driver</button></a>
    </div>
</body>
</html>