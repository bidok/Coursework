...
<table class="table">
    ...
    <#list taxiOfficeSalaryForDay as salary>
    <tr>
        <td><a href="/ui/salary/forday/taxioffice/get/${salary.id}">${salary.id}</a></td>
        <td>${salary.createTime}</td>
        <td>${salary.salary}</td>
        <td><a href="/ui/taxioffice/get/${salary.taxiOffice.id}">${salary.taxiOffice.name}</a></td>
        <td><a href="/ui/salary/forday/taxioffice/update/${salary.id}"><button type="button" class="btn btn-outline-dark">Update</button></a></td>
        <td><a href="/ui/salary/forday/taxioffice/delete/${salary.id}"><button type="button" class="btn btn-outline-dark">Delete</button></a></td>
    </tr>
    </#list>
</table>
    <a href="/ui/salary/forday/taxioffice/create"><button type="button" class="btn btn-outline-dark">Create</button></a>
</div>
</body>
</html>