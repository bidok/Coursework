...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div style="width: 400px; margin: 0 auto; margin-top: 50px">
        <h1 style="margin-left: 35%">taxi Office Salary For Day</h1>
        <ul class="list-group">

            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">ID</span>
                <input type="text" readonly placeholder=${taxiOfficeSalaryForDay.getId()}  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">TaxiOffice</span>
                <input type="text" readonly placeholder=${taxiOfficeSalaryForDay.getTaxiOffice().getName()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">Salary</span>
                <input type="text" readonly placeholder=${taxiOfficeSalaryForDay.getSalary()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">Created at</span>
                <input type="text" readonly placeholder=${taxiOfficeSalaryForDay.getCreateTime()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">updated at</span>
                <input type="text" readonly placeholder=${taxiOfficeSalaryForDay.getUpdateTime()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
        </ul>
        <a href="/ui/salary/forday/taxioffice/get/all"><button type="button" class="btn btn-outline-dark">To the list</button></a>
        <a style="float: right" href="/ui/taxioffice/get/${taxiOfficeSalaryForDay.getTaxiOffice().getId()}"><button type="button" class="btn btn-outline-dark" >To tAXI oFFICE</button></a>
    </div>
</body>
</html>