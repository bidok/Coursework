...
<div style="width: 400px; margin: 0 auto; margin-top: 50px">
	<ul class="list-group">
		...
		<div class="input-group input-group-sm mb-3">
			<span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">Max</span>
			<input type="text" readonly placeholder=${statistic.getMax()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
		</div>
		<div class="input-group input-group-sm mb-3">
			<span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">Min</span>
			<input type="text" readonly placeholder=${statistic.getMin()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
		</div>
		<div class="input-group input-group-sm mb-3">
			<span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">Avg</span>
			<input type="text" readonly placeholder=${statistic.getAverage()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
		</div>
	</ul>
