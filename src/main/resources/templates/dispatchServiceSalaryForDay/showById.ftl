    ...
    <div style="width: 400px; margin: 0 auto; margin-top: 50px">
        ...
        <ul class="list-group">
            ...
            <div class="input-group input-group-sm mb-3">
                ...
                <input type="text" readonly placeholder=${dispatchServiceSalaryForDay.getId()}  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">Salaryr</span>
                <input type="text" readonly placeholder=${dispatchServiceSalaryForDay.getSalary()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">Created at</span>
                <input type="text" readonly placeholder=${dispatchServiceSalaryForDay.getCreateTime()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="width: 120px">updated at</span>
                <input type="text" readonly placeholder=${dispatchServiceSalaryForDay.getUpdateTime()} class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            </div>
        </ul>
        <a href="/ui/salary/forday/dispatchservice/get/all"><button type="button" class="btn btn-outline-dark">To the list</button></a>
         </div>
</body>
</html>