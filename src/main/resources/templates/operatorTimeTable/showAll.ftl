...
<table class="table">
    ...
    <#list timeTable as timetable>
    <tr>
        <td><a href="/ui/timetable/operator/get/${timetable.id}">${timetable.id}</a></td>
        <td>${timetable.startWork}</td>
        <td>${timetable.endWork}</td>
       <td><a href="/ui/operator/get/${timetable.worker.id}">${timetable.worker.name}</a></td>

        <td><a href="/ui/timetable/operator/update/${timetable.id}"><button type="button" class="btn btn-outline-dark">Update</button></a></td>
        <td><a href="/ui/timetable/operator/delete/${timetable.id}"><button type="button" class="btn btn-outline-dark">Delete</button></a></td>
    </tr>
    </#list>
</table>
    <a href="/ui/timetable/operator/create"><button type="button" class="btn btn-outline-dark">Create</button></a>
</div>
</body>
</html>