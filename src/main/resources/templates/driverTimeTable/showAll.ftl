...
<table class="table">
    ...
    <tr>
        <td><a href="/ui/timetable/driver/get/${timetable.id}">${timetable.id}</a></td>
        <td>${timetable.startWork}</td>
        <td>${timetable.endWork}</td>
       <td><a href="/ui/driver/get/${timetable.worker.id}">${timetable.worker.name}</a></td>

        <td><a href="/ui/timetable/driver/update/${timetable.id}"><button type="button" class="btn btn-outline-dark">Update</button></a></td>
        <td><a href="/ui/timetable/driver/delete/${timetable.id}"><button type="button" class="btn btn-outline-dark">Delete</button></a></td>
    </tr>
    </#list>
</table>
    <a href="/ui/timetable/driver/create"><button type="button" class="btn btn-outline-dark">Create</button></a>
</div>
</body>
</html>