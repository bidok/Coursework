...
<table class="table">
    ...
    <#list discountCard as discountCard>
    <tr>
        <td><a href="/ui/discountcard/get/${discountCard.id}">${discountCard.id}</a></td>
        <td>${discountCard.cardNumber}</td>
        <td>${discountCard.discount}</td>
        <td>${discountCard.distance}</td>
        <td><a href="/ui/discountcard/update/${discountCard.id}"><button type="button" class="btn btn-outline-dark">Update</button></a></td>
        <td><a href="/ui/discountcard/delete/${discountCard.id}"><button type="button" class="btn btn-outline-dark">Delete</button></a></td>
    </tr>
    </#list>
</table>
    <a href="/ui/discountcard/create"><button type="button" class="btn btn-outline-dark">Create</button></a>
</div>
</body>
</html>